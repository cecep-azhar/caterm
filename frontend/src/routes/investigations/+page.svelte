...
<div class="max-w-5xl mx-auto space-y-6">
  <div class="flex justify-between items-center pb-4 border-b border-neutral-200 dark:border-neutral-800/80 mb-6">
    <div>
      <h1 class="text-2xl font-bold text-neutral-900 dark:text-white tracking-tight">Investigations</h1>
      <p class="text-neutral-500 dark:text-neutral-400 text-sm mt-1">Review saved security incidents, timelines, and audit evidence.</p>
      {#if !backendAvailable}
