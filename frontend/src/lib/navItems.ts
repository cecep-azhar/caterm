// Sidebar destinations, shared by the layout and the command palette. Functions (not constants)
// so labels resolve through t() in the caller's reactive context and follow the locale.
import { t } from '$lib/i18n/index.svelte';

export interface NavItem {
  href: string;
  label: string;
  /** SVG path for the 24×24 outline icon. */
  path: string;
}
